/**
 * @description 页面布局JS，
 * 依赖jquery.js，jqapp.js
 *
 *
Core script to handle the entire theme and core functions
**/
var Layout = (function (window, $, App, document, undefined) {

    var layoutImgPath = '../../assets/layouts/layout/img/';

    var layoutCssPath = '../../assets/layouts/layout/css/';
    ...
    return {
        ...
        /**
         * @depecated 页面布局初始化总入口暂时不用，局部模版加载完成时调用当前局部的初始化函数
         * @description 页面布局总入口
         */
        init: function () {
            this.initHeader();
